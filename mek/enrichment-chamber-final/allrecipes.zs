...
mods.thermalexpansion.InductionSmelter.removeRecipe(<moreplates:refined_glowstone_plate>, <minecraft:sand>);
mods.thermalexpansion.InductionSmelter.removeRecipe(<minecraft:sand>, <moreplates:refined_glowstone_gear>);
